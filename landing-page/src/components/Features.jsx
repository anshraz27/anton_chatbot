...
const Features = () => {
  const features = [
    {
      ...
      description:
        "Anton leverages RAG (Retrieval-Augmented Generation) to maintain conversation context and provide relevant responses.",
    ...
    },
    {
      ...
      description:
        "The system models and evolves personality through user interactions, creating a more natural conversational experience.",
    ...
    },
    {
      ...
      description:
        "Pinecone vector database enables semantic search and efficient retrieval of relevant conversation context.",
    ...
    },
    {
      ...
      description:
        "Special support for Hindi-English mixed language conversations, making the experience more natural for Indian users.",
    ...
    },
    {
      ...
      description:
        "Multiple chained LLMs enable more complex reasoning and natural responses through progressive stages.",
    ...
    },
    {
      ...
      description:
        "Seamless connection with Telegram via native API clients for real-time messaging and media handling.",
  ...
  return (
    ...
    >
      ...
      <AbstractGradient
        className="absolute bottom-1/3 right-10 w-80 h-80 opacity-5"
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="text-center mb-24 md:mb-32 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto">
            Anton combines cutting-edge AI technologies to deliver a
            sophisticated conversational experience with a uniquely evolving
            personality.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-15 transition-opacity duration-500 bg-gradient-to-br ${feature.gradient} rounded-2xl pointer-events-none`}
              ></div>

              {/* Icon Container */}
              <div className="mb-6 flex items-center relative z-10">
                <div
                  className={`w-14 h-14 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center transform transition-all duration-300 shadow-lg group-hover:shadow-xl group-hover:scale-110`}
                >
                  {feature.icon}
                </div>
          ...
          <div className="apple-card p-0 overflow-hidden relative z-10 group">
            ...
            <div className="flex flex-col lg:flex-row">
              <div className="w-full lg:w-1/2 p-10 md:p-12 lg:p-16 xl:p-20 flex flex-col justify-center">
                ...
                <h3 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-white leading-tight">
                  Retrieval-Augmented Generation (RAG)
                </h3>
                <p className="text-lg text-gray-400 mb-8 md:mb-10 leading-relaxed">
                  Anton leverages cutting-edge RAG architecture to combine
                  vector search with language model generation, creating
                  responses that are grounded in your conversation history.
                </p>
                <ul className="space-y-5">
                  {[
                    "Document embedding with Gemini models",
