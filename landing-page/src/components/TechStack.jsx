...
const TechStack = () => {
  const technologies = [
    {
      ...
      description:
        "Modern, responsive web interface built with React and styled with TailwindCSS.",
    ...
    },
    {
      ...
      description:
        "Flexible microservice architecture with both NodeJS and Python implementations.",
    ...
    },
    {
      ...
      description:
        "Cutting-edge AI models with retrieval augmentation for context-aware responses.",
      items: [
    ...
    },
    {
      ...
      description:
        "Combination of traditional and vector databases for efficient retrieval.",
    ...
    },
    {
      ...
      description:
        "Native Telegram API integration for seamless messaging experience.",
      items: [
        "gram.js (Node.js)",
        "Telethon (Python)",
        "MTProto API",
  ...
  return (
    ...
    >
      ...
      <AbstractGradient
        className="absolute top-1/3 right-1/4 w-80 h-80 opacity-5"
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-24 md:mb-32 max-w-3xl mx-auto">
          ...
          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto">
            Anton is built on a microservice architecture with cutting-edge
            technologies that make sophisticated AI conversations possible.
          </p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-7/12 p-10 md:p-16 lg:p-20">
              ...
              <p className="text-lg text-gray-400 mb-10 leading-relaxed">
                Anton is built with a flexible, scalable microservice
                architecture that combines Node.js and Python backends with
                powerful AI components for natural conversations.
              </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Handles Telegram integration and message processing",
                  ...
                  },
                  {
                    ...
                    description:
                      "Stores and retrieves semantic data with Pinecone",
                  ...
                  <div key={i} className="flex group/item">
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-white mb-1 group-hover/item:text-blue-400 transition-colors duration-300">
                        {item.title}
                      </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {technologies.map((tech, index) => (
            <div
              key={index}
              className="apple-card p-8 md:p-10 relative overflow-hidden group hover:translate-y-[-8px] transition-all duration-300"
            >
              {/* Background gradient on hover */}
              <div
                className={`absolute inset-0 opacity-0 group-hover:opacity-15 transition-opacity duration-500 bg-gradient-to-br ${tech.gradient} rounded-2xl pointer-events-none`}
              ></div>
              ...
              <div className="flex items-start mb-6 relative z-10">
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${tech.gradient} flex items-center justify-center text-white transform transition-all duration-300 shadow-lg group-hover:shadow-xl group-hover:scale-110 mr-4`}
                >
                  {tech.icon}
                </div>
              ...
              <div className="flex flex-wrap gap-2 relative z-10">
                {tech.items.map((item, i) => (
                  <span
                    key={i}
                    className="inline-block px-3 py-1 bg-[#101010] group-hover:bg-[#151515] rounded-full text-sm text-gray-300 border border-gray-800/50 transition-colors duration-300"
                  >
                    {item}
                  </span>
                ))}
