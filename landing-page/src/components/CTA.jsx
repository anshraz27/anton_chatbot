      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          ...
          <g opacity="0.15">
            {/* Circuit patterns */}
            <path
              d="M10,10 L50,10 L50,50 L90,50 L90,90"
            ...
            />
            <path
              d="M100,100 L140,100 L140,60 L180,60 L180,20"
              stroke="rgba(99, 102, 241, 0.3)"
              strokeWidth="0.5"
              fill="none"
              strokeDasharray="1,3"
          ...
          <div className="relative text-center max-w-5xl mx-auto">
            ...
            <motion.div variants={fadeInUp} transition={{ duration: 0.6 }}>
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-8 sm:mb-10 text-white leading-tight">
                Experience Advanced
                <br className="hidden sm:block" /> Conversational AI Today
              </h2>
            </motion.div>
            ...
            >
              <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                Anton combines RAG technology, vector databases, and fine-tuned
                models to deliver context-aware conversations with a uniquely
