    ...
    <section id="hero" className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-black">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1579546929518-9e396f3cc809?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1950&q=80')",
          }}
        ></div>
      ...
      <AbstractGradient
        className="absolute top-1/4 left-1/5 w-72 h-72 opacity-10"
        colorClass="from-blue-500 to-indigo-500"
      />
      <AbstractGradient
        className="absolute bottom-1/3 right-1/4 w-96 h-96 opacity-5"
        colorClass="from-purple-500 to-indigo-500"
      />
      <AbstractGradient
        className="absolute bottom-1/4 left-1/3 w-64 h-64 opacity-5"
      ...
      <div className="container mx-auto relative z-10 py-36 md:py-44">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-24">
          ...
          <div className="w-full lg:w-5/12 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
            ...
            >
              Experience natural, context-aware conversations with an AI
              assistant that evolves with every interaction. Available now on
              Telegram.
            </motion.p>
            <motion.div
            ...
            >
              <div className="px-5 py-3 bg-gradient-to-r from-blue-900/30 to-indigo-900/30 rounded-xl border border-blue-800/30 backdrop-blur-sm">
                ...
                <p className="text-gray-300 text-xs leading-relaxed">
                  This project is under active development and is in initial
                  stage. There may be lots of inconsistencies and bugs. It will
                  be soon released as open source for contribution.
                </p>
              </div>
            </motion.div>
          </div>
            ...
            <DeviceMockup className="w-full max-w-md transform rotate-3 hover:rotate-0 transition-transform duration-700">
              <div className="h-[600px] bg-black">
                ...
                <div className="p-5 bg-black space-y-5">
                  ...
                  <div className="bg-[#0066CC] rounded-2xl rounded-tr-sm px-4 py-2 max-w-[80%] ml-auto">
                    <p className="text-white text-base">
                      boss ne bola "let's sync" and I knew mera mood khatam
                    </p>
                    <p className="text-blue-200 text-xs mt-1 text-right">
                      11:26 AM
                    </p>
                  ...
                  <div className="bg-[#0066CC] rounded-2xl rounded-tr-sm px-4 py-2 max-w-[80%] ml-auto">
                    <p className="text-white text-base">
                      arey sach mein… kal se HR banne ka plan hai
                    </p>
                    <p className="text-blue-200 text-xs mt-1 text-right">
                      11:27 AM
                    </p>
                  ...
                  <div className="bg-[#1D1D1F] rounded-2xl rounded-tl-sm px-4 py-2 max-w-[80%]">
                    <p className="text-gray-200 text-base">
                      tu HR bani toh sab cry karenge
                    </p>
                    <p className="text-gray-500 text-xs mt-1 text-right">
                      11:27 AM
                    </p>
                  ...
                  <div className="bg-[#0066CC] rounded-2xl rounded-tr-sm p-4 max-w-[80%] ml-auto">
                    <p className="text-white text-base">
                      kar toh rahi thi… tum disturb kar diye
                    </p>
                    <p className="text-blue-200 text-xs mt-1 text-right">
                      11:30 AM
                    </p>
      ...
      <style jsx>{`
        ...
        .stars2 {
          ...
          background-image: radial-gradient(
            ...
            radial-gradient(
              4px 4px at 40px 70px,
              rgba(88, 28, 135, 0.2),
              rgba(88, 28, 135, 0)
            ),
            radial-gradient(
              4px 4px at 50px 160px,
              rgba(76, 29, 149, 0.2),
              rgba(76, 29, 149, 0)
            ),
            radial-gradient(
            ...
            radial-gradient(
              4px 4px at 130px 80px,
              rgba(139, 92, 246, 0.2),
              rgba(139, 92, 246, 0)
            ),
            radial-gradient(
              4px 4px at 160px 120px,
              rgba(59, 130, 246, 0.2),
              rgba(59, 130, 246, 0)
            );
